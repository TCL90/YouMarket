...
//		return this.listCarrito(carrito);
	...
	public List<ProductoCarrito> eliminarProducto(@RequestBody Map<String, Integer> postProducto,
	...
	public Cesta carritoACesta(@RequestBody Map<String, String> postCesta, HttpServletRequest request,
			HttpSession session, @CurrentUser UserPrincipal currentUser) {
	...
	public Cesta carritoACesta(@RequestBody List<ProductoCarrito> prods, @PathVariable Integer idCesta,
