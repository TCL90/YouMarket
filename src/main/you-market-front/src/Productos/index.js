...
function Productos() {
  ...
  const fetchProductos = useCallback(() => {
    return fetch("https://youmarket-entrega5.herokuapp.com/producto/list")
      .then((res) => res.json())
      .then((productos) => {
  ...
  const fetchMarcas = useCallback(() => {
    return fetch("https://youmarket-entrega5.herokuapp.com/producto/marcas")
      .then((res) => res.json())
      .then((marcas) => {
        setMarcas(marcas);
        console.log(marcas);
  ...
  const fetchSupermercados = useCallback(() => {
    return fetch("https://youmarket-entrega5.herokuapp.com/producto/supermercados")
      .then((res) => res.json())
      .then((supermercados) => {
