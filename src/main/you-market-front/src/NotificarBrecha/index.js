...
class NotificarBrecha extends React.Component {
  ...
  hazFetch() {
    fetch("https://youmarket-entrega5.herokuapp.com/brecha/alertar", {
      headers: {
  ...
  componentWillMount() {
    fetch("https://youmarket-entrega5.herokuapp.com/brecha/devuelveBrecha", {
      headers: {
        Authorization: "Bearer " + localStorage.getItem("auth"),
      },
      method: "GET",
  ...
  render() {
    ...
    return (
      <div>
        ...
        <center>
          <img
            src="https://www.lineex.es/wp-content/uploads/2018/06/alert-icon-red-11-1.png"
            alt="alert"
            id="alert"
          />
          ...
          <div className="producto-detalle-container container clearfix">
            ...
            <button className="button-finish" onClick={this.hazFetch}>
