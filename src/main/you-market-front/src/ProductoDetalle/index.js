...
function ProductoDetalle() {
  ...
  const fetchProducto = useCallback(() => {
    return fetch(`https://youmarket-entrega5.herokuapp.com/producto/${id}`)
      .then((res) => res.json())
      .then((producto) => {
  ...
  const renderDescription = () => {
    if (producto.descripcion != null) {
      return (
        <div className="producto-detalle-field">{producto.descripcion}</div>
      );
    }
  };
      ...
      <div>
        <div className="producto-detalle-container container clearfix">
          ...
          <div className="producto-detalle-info">
            ...
            <div className="producto-detalle-field">
              <b> Precio con IVA: </b> {producto.precioIva.toFixed(2)}{" "}
              {producto.unidad}
            </div>
            <div className="producto-detalle-field">
              <b> Marca: </b>
            ...
            <div className="producto-add-contenedor">
              <div className="producto-editar-cantidad clearfix">
                <img
                  ...
                  alt="Quitar uno"
                />
                <p id={idContador} className="contador no-link">
                  {cantidad}
                </p>
                <img
                  className="mas"
              ...
              <button
                className="producto-detalle-add"
                onClick={() =>
                  storeProdSession(
                    producto.id,
                    cantidad,
