...
function PerfilForm() {
  ...
  const fetchUsuario = useCallback(() => {
    return fetch("https://youmarket-entrega5.herokuapp.com/usuario/userPerfil", {
      headers: {
  ...
  const fetchUsuario2 = useCallback(() => {
    return fetch("https://youmarket-entrega5.herokuapp.com/usuario/direccion", {
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
        Authorization: "Bearer " + localStorage.getItem("auth"),
      ...
      <Formik
        ...
        validate={(values) => {
          ...
          if (
            ...
            !/^[a-zA-Z0-9]+@[a-zA-Z0-9]+\.[A-Za-z]+$/.test(values.usuario.email)
          ) {
        ...
        onSubmit={(values, { setSubmitting }) => {
          setTimeout(() => {
            fetch("https://youmarket-entrega5.herokuapp.com/usuario/updatePerfil", {
              headers: {
                "Content-Type": "application/json",
                Accept: "application/json",
                Authorization: "Bearer " + localStorage.getItem("auth"),
        ...
        {({
          ...
          <div className="registro-container">
            <form onSubmit={handleSubmit}>
              <Card
                title="Editar perfil"
                subTitle="Cambie los datos que desee modificar"
                style={{ margin: 20 }}
              >
                <div className="row">
                  <span className="span">
