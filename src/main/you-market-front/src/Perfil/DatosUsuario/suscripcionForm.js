  ...
  return (
    <div>
      ...
      <div className="container">
        <p style={{ margin: 20 }}>
          Si cambias tu suscripción, podrás realizar el pago el día 1 del
          próximo mes.
        </p>
        <p style={{ margin: 20 }}>
          <b> ATENCIÓN: </b> una vez pagada la nueva suscripción, si aún tenías
          algún envío en la antigua, los perderás.
        </p>
        <Card
          title="Modificación de la suscripción"
          subTitle="Seleccione la suscripción a la que desea cambiar"
          style={{ margin: 20 }}
        >
          <Formik
            initialValues={{
            ...
            onSubmit={(values, { setSubmitting }) => {
              values.suscripcion.id = document.getElementById(
                "selectSuscripciones"
              ).value;
              setTimeout(() => {
