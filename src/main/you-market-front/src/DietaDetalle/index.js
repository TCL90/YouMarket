...
function DietaDetalle() {
  ...
  const fetchDieta = useCallback(() => {
    return fetch(`https://youmarket-entrega5.herokuapp.com/dieta/${id}`, {
      headers: {
  ...
  return (
    <div>
      ...
      <div className="dieta-detalle-container container clearfix">
        <img
          className="dieta-detalle-imagen"
          src={dieta.url_imagen}
          alt={dieta.nombre}
        />
        <div className="dieta-detalle-info">
          ...
          <NavLink
            to={`../../../producto/dieta/list/${dieta.id}`}
            className="dieta-detalle-productos link-button"
          >
            Productos
          </NavLink>

          <NavLink
            to={`../../../recetas/list/${dieta.id}`}
            className="dieta-detalle-recetas link-button"
          >
