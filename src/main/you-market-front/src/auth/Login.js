...
class Login extends React.Component {
  ...
  adminCheck() {
    fetch("https://youmarket-entrega5.herokuapp.com/usuario/adminCheck", {
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
        Authorization: "Bearer " + localStorage.getItem("auth"),
        ...
        <div className="caja-form">
          ...
          <div>
            <span className="p-float-label" className="span-login">
              <p className="registrado-p">{this.state.signup}</p>
            </span>
          </div>
          <Formik
            ...
            onSubmit={(values, { setSubmitting }) => {
              setTimeout(() => {
                fetch("https://youmarket-entrega5.herokuapp.com/usuario/signIn", {
                  headers: {
                    "Content-Type": "application/json",
                  },
                  method: "POST",
