...
function Carro() {
  ...
  const fetchMsg = useCallback(() => {
    return fetch("https://youmarket-entrega5.herokuapp.com/usuario/alertaPago", {
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
        Authorization: "Bearer " + localStorage.getItem("auth"),
            ...
            <div className="vaciar-carrito">
              <Formik
                onSubmit={(values, { setSubmitting }) => {
                  setTimeout(() => {
                    fetch("https://youmarket-entrega5.herokuapp.com/carritoDestroy", {
                      headers: {
                        "Content-Type": "application/json",
                        Accept: "application/json",
                        Authorization: "Bearer " + localStorage.getItem("auth"),
              ...
              {localStorage.getItem("cestasCheck") > 0 ? (
                <div className="guardar-carrito-a-cesta">
                  ...
                  <Formik
                    ...
                    onSubmit={(values, { setSubmitting }) => {
                      setTimeout(() => {
                        fetch(`https://youmarket-entrega5.herokuapp.com/carritoACesta/${values.id}`, {
                          headers: {
                            "Content-Type": "application/json",
                            Accept: "application/json",
                            Authorization:
