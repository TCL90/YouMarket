...
export function PedidoForm() {
  ...
  function totalDeCestas(values) {
    fetch("https://youmarket-entrega5.herokuapp.com/pedido/precio/", {
      ...
      .then((res) => res.json())
      .then((precio1) => setPrecioTotalCestas(precio1));
  ...
  useEffect(() => {
    construyeCarrito(),
      fetch("https://youmarket-entrega5.herokuapp.com/usuario/envios", {
        headers: {
          "Content-Type": "application/json",
  ...
  const precio = (values) => {
    ...
    const fetchTotal = useCallback(() => {
      return fetch("https://youmarket-entrega5.herokuapp.com/precioTotalCarrito", {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          Authorization: "Bearer " + localStorage.getItem("auth"),
  ...
  function pagar() {
    ...
    if (
      started === true &&
      errors.direccion1 === undefined &&
      errors.poblacion1 === undefined &&
      errors.cpostal1 === undefined &&
      errors.provincia1 === undefined &&
      errors.fechaEnvio1 === undefined &&
      errors.horaEnvioFin1 === undefined &&
      errors.horaEnvioIni1 === undefined &&
  ...
  const cestas = () => {
    ...
    const fetchCestas = useCallback(() => {
      return fetch("https://youmarket-entrega5.herokuapp.com/cesta/user/llenas", {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          Authorization: "Bearer " + localStorage.getItem("auth"),
      ...
      <div>
        {envioTomas > 0 ? (
          <div className="pedido-container container">
            <h1 id="titulo-pedidos">
              ¡Ya queda menos para finalizar tu pedido! Por favor, rellena estos
              campos 😉
            </h1>

            <h3 id="envios-restantes-pedidos">
              {" "}
              Te queda/n {envioTomas} envíos por realizar de tu suscripción.{" "}
            </h3>
            <Formik
              ...
              validate={(values) => {
                ...
                if (!values.direccion1) {
                  ...
                  values.direccion1.includes("javascript") ||
                  values.direccion1.includes(";")
                ) {
                ...
                if (!values.poblacion1) {
                  ...
                  values.poblacion1.includes("javascript") ||
                  values.poblacion1.includes(";")
                ) {
                ...
                if (!values.cpostal1) {
                  errors.cpostal1 =
                    "Campo obligatorio/Comprueba que no hayas introducido letras";
                ...
                if (!values.provincia1) {
                  ...
                  values.provincia1.includes("javascript") ||
                  values.provincia1.includes(";")
                ) {
                ...
                if (values.horaEnvioFin1 < values.horaEnvioIni1) {
                  errors.horaEnvioFin1 =
                    "La hora final no puede ser anterior a la inicial";
                }

                if (
                  values.horaEnvioFin1 === "" ||
                  values.horaEnvioFin1 == null
                ) {
                  errors.horaEnvioFin1 = "Campo obligatorio";
                }

                if (
                  values.horaEnvioIni1 === "" ||
                  values.horaEnvioIni1 == null
                ) {
                  errors.horaEnvioFin1 = "Campo obligatorio";
                }
                if (
                  values.horaEnvioFin1 < 9 ||
                  values.horaEnvioIni1 < 9 ||
                  values.horaEnvioFin1 > 21 ||
                  values.horaEnvioIni1 > 22
                ) {
                  errors.horaEnvioFin1 =
                    "En este tramo horario no se realizan entregas";
                } else if (values.horaEnvioFin1 === values.horaEnvioIni1) {
                  errors.horaEnvioFin1 =
                    "La hora de inicio de entrega no puede ser igual a la de final";
                } else if (values.horaEnvioFin1 < values.horaEnvioIni1) {
                  errors.horaEnvioFin1 =
                    "La hora de inicio de entrega no puede mayor a la de final";
                }
                ...
                if (pedido2mostrado === "si") {
                  if (!values.direccion2) {
                    ...
                    values.direccion2.includes("javascript") ||
                    values.direccion2.includes(";")
                  ) {
                  ...
                  if (!values.poblacion2) {
                    ...
                    values.poblacion2.includes("javascript") ||
                    values.poblacion2.includes(";")
                  ) {
                  ...
                  if (!values.provincia2) {
                    ...
                    values.provincia2.includes("javascript") ||
                    values.provincia2.includes(";")
                  ) {
                  ...
                  if (
                    values.horaEnvioFin2 < 9 ||
                    values.horaEnvioIni2 < 9 ||
                    values.horaEnvioFin2 > 21 ||
                    values.horaEnvioIni2 > 22
                  ) {
                    errors.horaEnvioFin2 =
                      "En este tramo horario no se realizan entregas";
                ...
                if (pedido3mostrado === "si") {
                  if (!values.direccion3) {
                    ...
                    values.direccion3.includes("javascript") ||
                    values.direccion3.includes(";")
                  ) {
                  ...
                  if (!values.poblacion3) {
                    ...
                    values.poblacion3.includes("javascript") ||
                    values.poblacion3.includes(";")
                  ) {
                  ...
                  if (!values.provincia3) {
                    ...
                    values.provincia3.includes("javascript") ||
                    values.provincia3.includes(";")
                  ) {
                  ...
                  if (
                    values.horaEnvioFin3 < 9 ||
                    values.horaEnvioIni3 < 9 ||
                    values.horaEnvioFin3 > 21 ||
                    values.horaEnvioIni3 > 22
                  ) {
                    errors.horaEnvioFin3 =
                      "En este tramo horario no se realizan entregas";
                ...
                if (pedido4mostrado === "si") {
                  if (!values.direccion4) {
                    ...
                    values.direccion4.includes("javascript") ||
                    values.direccion4.includes(";")
                  ) {
                  ...
                  if (!values.poblacion4) {
                    ...
                    values.poblacion4.includes("javascript") ||
                    values.poblacion4.includes(";")
                  ) {
                  ...
                  if (!values.provincia4) {
                    ...
                    values.provincia4.includes("javascript") ||
                    values.provincia4.includes(";")
                  ) {
                  ...
                  if (
                    values.horaEnvioFin4 < 9 ||
                    values.horaEnvioIni4 < 9 ||
                    values.horaEnvioFin4 > 21 ||
                    values.horaEnvioIni4 > 22
                  ) {
                    errors.horaEnvioFin4 =
                      "En este tramo horario no se realizan entregas";
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="pedido-form-envio-container">
                      <fieldset>
                        ...
                        <Field
                          ...
                          onFocus={empieza}
                        />
                        <div className="errores">{errors.poblacion1}</div>
                        <br />
                        <br />
                        ...
                        <Field
                          ...
                          pattern="^\d{5}$"
                        />
                        <div className="errores">{errors.cpostal1}</div>
                        <br />
                        <br />
                        ...
                        <Field
                          ...
                          placeholder="Sevilla"
                        />
                        <div className="errores">{errors.provincia1}</div>
                        <br />
                        <br />
                        ...
                        <div className="errores">{errors.direccion1}</div>
                        <br />
                        <br />
                        ...
                        <Field
                          ...
                          min={today}
                        />
                        <div className="errores">{errors.fechaEnvio1}</div>
                        <br />
                        <br />
                        ...
                        <Field
                          ...
                          required
                        />
                        <div className="errores">{errors.horaEnvioIni1}</div>
                        ...
                        <Field
                          ...
                          required
                        />
                        <div className="errores">{errors.horaEnvioFin1}</div>
                        <br />
                        <br />
                        <label htmlFor="cestaId1" className="s">
                          {" "}
                          Elige tu cesta:{" "}
                        </label>
                        <select
                  ...
                  {envioTomas > 1 ? (
                    <div id="enlace1" className="pedido-margin">
                      <div>
                        <a
                          href="#enlaceMostrarPedido2"
                          className="link-button"
                          onClick={mostrarPedido2}
                          id="enlaceMostrarPedido2"
                        >
                  ...
                  <div id="pedido2" className="pedido-margin">
                    <div className="pedido-form-envio-container">
                      <fieldset>
                        ...
                        <div className="errores">{errors.poblacion2}</div>
                        <br />
                        <br />
                        ...
                        <div className="errores">{errors.cpostal2}</div>
                        <br />
                        <br />
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                        />
                        <div className="errores">{errors.provincia2}</div>
                        <br />
                        <br />
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                        />
                        <div className="errores">{errors.direccion2}</div>
                        <br />
                        <br />
                        ...
                        <input
                          ...
                          min={today}
                        />
                        <div className="errores">{errors.fechaEnvio2}</div>
                        <br />
                        <br />
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                        />
                        <div className="errores">{errors.horaEnvioIni2}</div>
                  ...
                  <div id="enlace2" className="pedido-margin">
                    ...
                    <br />
                    <a
                      href="#enlaceMostrarPedido3"
                      className="link-button"
                      onClick={mostrarPedido3}
                      id="enlaceMostrarPedido3"
                    >
                    ...
                    <div className="pedido-form-envio-container">
                      <fieldset>
                        ...
                        <input
                          ...
                          placeholder="Los Palacios y Villafranca"
                        />
                        <div className="errores">{errors.poblacion3}</div>
                        <br />
                        <br />
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                        />
                        <div className="errores">{errors.cpostal3}</div>
                        <br />
                        <br />
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                        />
                        <div className="errores">{errors.provincia3}</div>
                        <br />
                        <br />
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                        />
                        <div className="errores">{errors.direccion3}</div>
                        <br />
                        <br />
                        ...
                        <input
                          ...
                          min={today}
                        />
                        <div className="errores">{errors.fechaEnvio3}</div>
                        <br />
                        <br />
                        ...
                        <input
                          ...
                          required
                        />
                        <div className="errores">{errors.horaEnvioIni3}</div>
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                        />
                        <div className="errores">{errors.horaEnvioFin3}</div>
                        <br />
                        <br />

                        <label htmlFor="cestaId3" className="s">
                          {" "}
                          Elige tu cesta:{" "}
                        </label>
                        <select
                  ...
                  <div id="enlace3" className="pedido-margin">
                    ...
                    <br />
                    <a
                      href="#enlaceMostrarPedido4"
                      className="link-button"
                      onClick={mostrarPedido4}
                      id="enlaceMostrarPedido4"
                    >
                    ...
                    <div className="pedido-form-envio-container">
                      <fieldset>
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                        />
                        <div className="errores">{errors.poblacion4}</div>
                        <br />
                        <br />
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                        />
                        <div className="errores">{errors.cpostal4}</div>
                        <br />
                        <br />
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                        />
                        <div className="errores">{errors.provincia4}</div>
                        <br />
                        <br />
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                        />
                        <div className="errores">{errors.direccion4}</div>
                        <br />
                        <br />
                        ...
                        <input
                          ...
                          min={today}
                        />
                        <div className="errores">{errors.fechaEnvio4}</div>
                        <br />
                        <br />
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                        />
                        <div className="errores">{errors.horaEnvioIni4}</div>
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                        />
                        <div className="errores">{errors.horaEnvioFin4}</div>
                        <br />
                        <br />
                  ...
                  <div>
                    <a id="pagar-a" href="#">
                      <button onClick={pagar} className="button-finish">
                        Pagar
                      </button>
                    </a>
                  </div>
                  <div className="grid" id="paypal-b">
                    ...
                    <PayPalButton
                      ...
                      onSuccess={(valuesP, { setSubmitting }) => {
                        setTimeout(() => {
                          fetch("https://youmarket-entrega5.herokuapp.com/pedido/create", {
                            headers: {
                              "Content-Type": "application/json",
                              Authorization:
                      ...
                      options={{
                        clientId:
                          "AQ1wSRRux5eVDHDZia2gH5NfFd_dO2-mooYqs-CdF3E53DIHclXqJlDI_2I2vtfIeQi5qVQTciRnOS9Y",
                        currency: "EUR",
                      }}
                    />
                  </div>
